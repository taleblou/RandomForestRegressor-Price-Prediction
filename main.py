...
file_path = f"RandomForestRegressor{name}.txt"
def text_write(text):
    print(text)
...
def build_model(X_train,Y_train):
    ...
    # Train the model with the best parameters found from GridSearchCV
...
for c in ['Open','High','Low','Close']:
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig(f"RandomForestRegressor_{c}_{name}.png")
    plt.close()
    plt.cla()
